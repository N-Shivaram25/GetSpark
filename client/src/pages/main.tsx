      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-6 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="flex items-center justify-between">
            <h4 className="font-medium text-card-foreground">Active Keywords</h4>
        ...
        {detectedKeywords.length > 0 && (
          <div className="mb-6">
            <h4 className="font-medium text-foreground mb-2">Detected Keywords</h4>
        ...
        {displayedImages.length > 0 && (
          <div className="mb-6">
            <h4 className="font-medium text-foreground mb-2">Generated Images</h4>
                ...
                <div key={image.id} className="relative bg-card rounded-lg shadow-sm overflow-hidden">
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {image.source === 'clipdrop' ? 'Generated by ClipDrop' : 'Custom Image'}
                    </p>
                  </div>
